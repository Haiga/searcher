...
class Reranker():
    ...
    def get_sentence_model(self, model_path="/home/silvapedro/searcher/search_engine/bert-base-portuguese-cased/"):
        args = {'from_tf':False}
        word_embedding_model = models.Transformer(model_path, max_seq_length=500, model_args=args)
