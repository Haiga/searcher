...
def get_sentence_model(model_path="/home/silvapedro/searcher/search_engine/bert-base-portuguese-cased/temp/"):
...
class Indexer:
    ...
    def __init__(self, elastic_address='localhost:9200', model_path="/home/silvapedro/searcher/search_engine/bert-base-portuguese-cased/temp/", username=None, password=None):
