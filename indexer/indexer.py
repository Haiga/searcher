...
def get_sentence_model(model_path="neuralmind/bert-base-portuguese-cased/bert-base-portuguese-cased/"):
...
class Indexer:
    ...
    def __init__(self, elastic_address='localhost:9200', model_path="neuralmind/bert-base-portuguese-cased/bert-base-portuguese-cased/", username=None, password=None):
