...
def get_sentence_model(model_path="bert-base-uncased"):
...
class Indexer:
    ...
    def __init__(self, elastic_address='localhost:9200', model_path="bert-base-uncased", username=None, password=None):
